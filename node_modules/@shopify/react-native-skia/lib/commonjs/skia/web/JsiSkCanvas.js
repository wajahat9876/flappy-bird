...
class JsiSkCanvas extends _Host.HostObject {
  ...
  drawAtlas(atlas, srcs, dsts, paint, blendMode, colors, _sampling) {
    ...
    this.ref.drawAtlas(_JsiSkImage.JsiSkImage.fromValue(atlas), src, dst, _JsiSkPaint.JsiSkPaint.fromValue(paint), blendMode ? (0, _Host.getEnum)(this.CanvasKit.BlendMode, blendMode) : this.CanvasKit.BlendMode.DstOver, cls);
  }
